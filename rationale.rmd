...
A prototype alternative form of representing this information is in the `sc` package, which is in early stages. (The current design is a distillation and improvement onprevious implementations, see `mdsumner/gris` and `r-gris/rangl` for these earlier attempts).
