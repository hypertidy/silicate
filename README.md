...
NOTE: as of January 2018 major work is going on in the **pslg** branch, this will be disruptive so **master** will remain stable in the original PATH/PRIMITIVE form until we figure the edge-first scheme.
