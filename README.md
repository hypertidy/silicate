...
[![Travis-CI Build Status](https://travis-ci.org/mdsumner/silicate.svg?branch=master)](https://travis-ci.org/mdsumner/silicate) [![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/mdsumner/silicate?branch=master&svg=true)](https://ci.appveyor.com/project/mdsumner/silicate) [![Coverage Status](https://img.shields.io/codecov/c/github/mdsumner/silicate/master.svg)](https://codecov.io/github/mdsumner/silicate?branch=master)
