...
Currently silicate can only provide the second form, the ear-clipping method as used in package `rgl`. 
...
The [CRAN package sfdct](https://CRAN.R-project.org/package=unjoin) will use the first method (package `RTriangle` wraps the Triangle library) for simple features. 
