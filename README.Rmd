...
This package is intended to be the central guide to the `common form` approach described here. There's nothing in the package yet, but see these projects that are informed by this approach. 
