...
1. Provide tools for decomposing geo-spatial data to common general forms. 
2. Promote use of the general approach rather than localized implementations. 
3. Document key efficiencies and improvements across widely used R packages. 
4. Implement a prototype general-form geo-spatial-graphics package that is a superset of raster and sf and ggplot2. 
